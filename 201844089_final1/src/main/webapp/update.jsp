...
<body>
	...
	<div class="container">
		<div class="row">
			<form action="updateAction.jsp?bbsID=<%=bbsID %>" method="post" name="frm" onsubmit="return check()" enctype="multipart/form-data">
					...
					<tbody>
						...
						<tr>
							<td style="text-align: left;">
								<input type="radio" name="anonymous" value="false"/>노익명<br>
